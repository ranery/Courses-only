...
img_dir = '/home/zhoupan/disk1/cityscapes/trainA'
lab_dir = '/home/zhoupan/disk1/cityscapes/trainB'
lab_id_dir = '/home/zhoupan/disk1/cityscapes/trainB_cls'
...
f_img = open('./train.csv', 'w')
f_img.write('img,label\n')
file = os.listdir(lab_dir)
file.sort()

for filename in file:
	lab_name = os.path.join(lab_dir, filename)
	img_name = filename.split('gtFine')[0] + "leftImg8bit.png"
	img_name = os.path.join(img_dir, img_name)
	lab_id_name = os.path.join(lab_id_dir, filename)
	f_img.write("{},{}.npy\n".format(img_name, lab_id_name))

	if os.path.exists(lab_id_name + '.npy'):
		print('skip %s' % (filename))
		continue
	print('Parse %s' % (filename))
	img = scipy.misc.imread(lab_name, mode='RGB')
	...
	lab_id_name = lab_id_name + '.npy'
	np.save(lab_id_name, idx_mat)
	print('Finish %s' % (filename))

img_dir = '/home/zhoupan/disk1/cityscapes/testA'
lab_dir = '/home/zhoupan/disk1/cityscapes/testB'
lab_id_dir = '/home/zhoupan/disk1/cityscapes/testB_cls'

f_img = open('./test.csv', 'w')
f_img.write('img,label\n')
file = os.listdir(lab_dir)
file.sort()
